...
IMPLEMENT_DYNAMIC(CstudentCCDlg, CDialogEx)

CstudentCCDlg::CstudentCCDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG112, pParent)
	, na2(_T(""))
	, na3(_T(""))
	, na1(_T(""))
{
...
CstudentCCDlg::~CstudentCCDlg()
{
}

void CstudentCCDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CstudentCCDlg, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON1, &CstudentCCDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDOK, &CstudentCCDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CstudentCCDlg 消息处理程序


void CstudentCCDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	...
	select_sql_by_user1.Format("select id,name,pass,fee from studentlogin where id = \'%s\'", na2);
...
void CstudentCCDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
